...
//     Configuration file:     "DotNetAppSqlDb\Web.config"
//     Connection String Name: "MyDBContext"
//     Connection String:      "data source=(localdb)\MSSQLLocalDB;Initial Catalog=MyDatabaseContext_201704031541;integrated security=True;multipleactiveresultsets=True;App=EntityFramework"
// ------------------------------------------------------------------------------------------------
...
namespace DotNetAppSqlDb.Models
{
    ...
    public class Todo
    {
        ...
        public string AnotherField { get; set; } // AnotherField (length: 50)
        public string Added { get; set; } // Added (length: 50)
    }
    ...
    public class TodoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Todo>
    {
        ...
        public TodoConfiguration(string schema)
        {
            ...
            Property(x => x.AnotherField).HasColumnName(@"AnotherField").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
            Property(x => x.Added).HasColumnName(@"Added").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
        }
    }
